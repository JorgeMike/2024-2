...
\text{1. Una urna contiene dos bolas sin pintar. Se selecciona una bola al azar y se lanza una moneda. Si la bola elegida no está pintada y la moneda produce cara, pintamos la bola de rojo. Si la moneda produce cruz la pintamos de negro. Si la bola ya está pintada, entonces cambiamos el color de la bola de rojo a negro o de negro a rojo, independientemente de si la moneda produce cara o cruz.} \\
\text{a) Obtenga matriz de transición} \\
\text{b) Obtenga el vector de distribución estacionaria} \\
\text{Tip: Identifique a cada estado como vectores con el siguiente formato} \ (S,R,N), \text{donde} \ S \ \text{es el número de bolas sin pintar,} \ R \ \text{es el número de bolas rojas y} \ N \ \text{es el número de bolas negras que hay en la urna.}
